...
@section('title')
   <title>Slide | Hikids Admin</title>
...
@section('content')
      <div class="page-head">
        <h2>{{ empty($slide->id) ? 'Thêm mới slide' : 'Sửa slide' }}</h2>
        <ol class="breadcrumb">
          <li><a href="{{ url('/manage/slide') }}">Slide</a></li>
          <li>{{ empty($slide->id) ? 'Thêm mới' : 'Sửa' }}</li>
        </ol>
      </div>
      <div class="cl-mcont">
          <div class="row">
            <div class="col-md-12">            
            {!! Form::open(['url' => '/manage/slide/'.$slide->id, 'method' => empty($slide->id) ? 'POST' : 'PUT', 'role' => 'form', 'files' => 'true', 'class' => 'form-horizontal group-border-dashed', 'style' => 'border-radius: 0px;', 'id' => 'form_slide',]) !!} 
                ...
                <div class="content">
                  ...
                  @include('errors/error_validation', ['errors' => $errors])
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        {!! Form::text('title', $slide->title, array('placeholder' => 'Tiêu đề', 'class' => 'form-control')) !!}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        {!! Form::text('link', $slide->link, array('placeholder' => 'Tiêu đề', 'class' => 'form-control')) !!}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="content" id="content" class="rich_text">{{ old('content') ? old('content') : $slide->content }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      @if (!empty($slide->thumbnail))
                        <img src="{{ config('image.image_url').'/slides/'.$slide->thumbnail.'_150x150.png' }}"/>
                        @else
              ...
              <div class="row block-flat">
                <div class="col-sm-offset-2 col-sm-10">
                    <a href="/manage/slide" class="btn btn-default">Trở lại</a>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $('#form_submit').click(function(){
          // $("#content").val($("#slide_content").code());
          $('#form_slide').submit();
        });
      });
