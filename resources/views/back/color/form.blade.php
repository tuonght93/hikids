...
@section('title')
   <title>Color | HappySkin Admin</title>
...
@section('content')
      <div class="page-head">
        <h2>{{ empty($color->id) ? 'Thêm mới màu' : 'Sửa màu' }}</h2>
        <ol class="breadcrumb">
          <li><a href="{{ url('/manage/color') }}">Color</a></li>
          <li>{{ empty($color->id) ? 'Thêm mới' : 'Sửa' }}</li>
        </ol>
      </div>
      <div class="cl-mcont">
          <div class="row">
            <div class="col-md-12">            
            {!! Form::open(['url' => '/manage/color/'.$color->id, 'method' => empty($color->id) ? 'POST' : 'PUT', 'role' => 'form', 'files' => 'true', 'class' => 'form-horizontal group-border-dashed', 'style' => 'border-radius: 0px;', 'id' => 'form_color',]) !!} 
                ...
                <div class="content">
                  ...
                  @include('errors/error_validation', ['errors' => $errors])
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        {!! Form::text('title', $color->title, array('placeholder' => 'Tiêu đề', 'class' => 'form-control')) !!}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="content" id="content" class="rich_text">{{ old('content') ? old('content') : $color->content }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      @if (!empty($color->thumbnail))
                        <img src="{{ config('image.image_url').'/colors/'.$color->thumbnail.'_150x150.png' }}"/>
                        @else
              ...
              <div class="row block-flat">
                <div class="col-sm-offset-2 col-sm-10">
                    <a href="/manage/color" class="btn btn-default">Trở lại</a>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $('#form_submit').click(function(){
          // $("#content").val($("#color_content").code());
          $('#form_color').submit();
        });
      });
