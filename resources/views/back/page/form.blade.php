...
@section('content')
      <div class="page-head">
        <h2>{{ empty($page->id) ? 'Thêm mới màu' : 'Sửa màu' }}</h2>
        <ol class="breadcrumb">
          <li><a href="{{ url('/manage/page') }}">Page</a></li>
          <li>{{ empty($page->id) ? 'Thêm mới' : 'Sửa' }}</li>
        </ol>
      </div>
      <div class="cl-mcont">
          <div class="row">
            <div class="col-md-12">            
            {!! Form::open(['url' => '/manage/page/'.$page->id, 'method' => empty($page->id) ? 'POST' : 'PUT', 'role' => 'form', 'files' => 'true', 'class' => 'form-horizontal group-border-dashed', 'style' => 'border-radius: 0px;', 'id' => 'form_page',]) !!} 
                ...
                <div class="content">
                  ...
                  @include('errors/error_validation', ['errors' => $errors])
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        {!! Form::text('title', $page->title, array('placeholder' => 'Tiêu đề', 'class' => 'form-control')) !!}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="content" id="content" class="rich_text">{{ old('content') ? old('content') : $page->content }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      @if (!empty($page->thumbnail))
                        <img src="{{ config('image.image_url').'/pages/'.$page->thumbnail.'_150x150.png' }}"/>
                        @else
              ...
              <div class="row block-flat">
                <div class="col-sm-offset-2 col-sm-10">
                    <a href="/manage/page" class="btn btn-default">Trở lại</a>
