...
window.ParsleyConfig.i18n.vi = $.extend(window.ParsleyConfig.i18n.vi || {}, {
  defaultMessage: "Trường này là không đúng.",
  type: {
    email:        "Trường email không hợp lệ.",
    url:          "Url không hợp lệ.",
    number:       "Trả lời này phải là 1 số.",
    integer:      "Trả lời này phải là 1 số Integer.",
    digits:       "Đây phải là ký tự.",
    alphanum:     "Đây phải là chữ."
  },
  notblank:       "Trả lời này không được bỏ trống.",
  required:       "Trả lời này là cần thiết.",
  pattern:        "This value seems to be invalid.",
  min:            "Trả lời này phải lớn hơn hoặc bằng %s.",
  max:            "Trả lời này phải nhỏ hơn hoặc bằng %s.",
  range:          "Trả lời này phải trong khoảng %s và %s.",
  minlength:      "Trả lời này quá ngắn. Giá trị phải có %s ký tự hoặc nhiều hơn.",
  maxlength:      "Trả lời này quá dài. Giá trị phải có %s ký tự hoặc ít hơn.",
  length:         "Trả lời này không hợp lệ. Giá trị phải trong khoảng %s và %s ký tự",
  mincheck:       "Bạn phải chọn ít nhất %s lựa chọn.",
  maxcheck:       "Bạn chỉ được chọn %s lựa chọn hoặc ít hơn.",
  check:          "Bạn phải chọn khoảng %s và %s lựa chọn.",
  equalto:        "Trả lời này phải giống nhau."
});
